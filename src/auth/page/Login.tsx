...
export const Login = () => {
  ...
  const handleClickLogin = async() => {
    ...
    if (success) {
      getUser({...userFirebase, title: '', description: ''})
    ...
    <div className="flex-1 container mx-auto flex justify-center mt-20 animate__animated animate__fadeIn">
      <div className="flex flex-col ">
        <div className="flex flex-col border-b border-b-white-100 py-10 gap-4">
          ...
          <button onClick={handleClickLogin} type="button" className="bg-gray-500 p-3 rounded-md w-full md:w-[300px] transition-all hover:bg-gray-400">Continue with Google</button>
